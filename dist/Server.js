 ...
 * @virtual
 */
Link.prototype.sendToClient = function (ev) {
...
Link.prototype.acceptFromServer = function (receiveFromClient) {
...
Link.prototype.receiveFromServer = function (ev) {
 ...
 * @virtual
 */
Server.prototype.publish = function (path, remutableConsumer) {
  if (__DEV__) {
...
Server.prototype.acceptLink = function (link) {
  var _this2 = this;
  if (__DEV__) {
...
Server.prototype.receiveFromLink = function (linkID, ev) {
  if (__DEV__) {
...
Server.prototype.sendToLinks = function (ev) {
  if (__DEV__) {
