...
var ClientAdapter = (function (ClientAdapterDuplex) {
  function ClientAdapter(worker) {
    if (__DEV__) {
  ...
  _inherits(ClientAdapter, ClientAdapterDuplex);

  _prototypeProperties(ClientAdapter, null, {
    fetch: {
      value: function (path, hash) {
        var _this = this;
        // ignore hash
...
var Link = (function (LinkDuplex) {
  // represents a client connection from the servers' point of view
...
/* jshint worker:true */
var ServerAdapter = (function (_Server$Adapter) {
  ...
  _prototypeProperties(ServerAdapter, null, {
    publish: {
      value: function (path, consumer) {
        if (__DEV__) {
          path.should.be.a.String;
    ...
    onConnection: {
      value: function (accept, lifespan) {
        var _this2 = this;
